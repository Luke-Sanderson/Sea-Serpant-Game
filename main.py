...
class Segment:
    ...
    def update(self):
        if self.canvas.coords(self.drawing)[1] > 200:
...
class Game:
    ...
    def __init__(self):
        ...
        for i in range(5):
            self.serpent.append(Segment(100 - 20 * len(self.serpent),100,self.canvas))
    ...
    def move_serpent(self):
        ...
        for index, segment in enumerate(self.serpent):
            ...
            if index != 0:
                ...
                if distance < 30 and segment.max_velocity > 0:
                    segment.max_velocity -= 0.05
                elif distance > 20:
                    segment.max_velocity += 0.05
